...
public class PushManageIos implements java.io.Serializable {
	...
	public PushManageIos(String platform, Long productNum, Long channelNum,
			String username, String userId, String action, String actionarg,
			String actionobj, String pushContent, Integer msgType,
			Integer pushType, String notice, Date showTime, Date createTime,
			String title) {
